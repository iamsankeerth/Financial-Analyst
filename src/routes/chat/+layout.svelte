<script lang="ts">
	...
	import { callStockAnalyze } from '../api/stock-analyze/call.js';
...
<svelte:head>
	<title>Chat | Financial Analyst</title>
	<meta
		name="viewport"
						...
						<div class="flex flex-grow flex-col">
							...
							<div class="relative flex flex-grow flex-row items-start">
								...
								<textarea
									...
									class="text-foreground dark:text-gray-50 placeholder:text-muted-foreground/50 max-h-64 min-h-[60px] w-full resize-none !overflow-y-auto bg-transparent px-3 text-base leading-6 outline-none disabled:cursor-not-allowed disabled:opacity-40 sm:min-h-[80px]"
							...
							<div class="mt-2 -mb-px flex w-full flex-row-reverse justify-between px-2">
								...
								<div class="flex flex-wrap items-center gap-2 pr-2">
									<div class="flex items-center gap-2">
										<div class="border-border flex items-center gap-1 rounded-full border px-2 py-1 text-xs text-muted-foreground transition-colors sm:px-3">
											<SparkleIcon class="text-primary !size-3" />
											<span class="whitespace-nowrap sm:inline">Financial Analyst</span>
										</div>
